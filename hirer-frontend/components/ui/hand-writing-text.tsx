  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto py-24">
      ...
      <div className="relative text-center z-10 flex flex-col items-center justify-center">
        <motion.h1
          className="font-handwritten text-8xl md:text-9xl text-black dark:text-white tracking-tight"
        ...
        {subtitle && (
          <motion.p
            className="font-mono text-sm text-black/60 dark:text-white/60 mt-4 tracking-widest uppercase"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
